  ...
  return (
    <div className="w-full">
      ...
      <SectionWrapper className="bg-base-secondary" id="quick-contact">
        {/* QuickContact reveals its own cards individually (per-card
            whileInView, like ServiceCards), so it is not wrapped — wrapping it
            would animate the block and then each card again on top, a visible
            double animation. */}
