    ...
    return (
        <>
            <div ref={container} className="w-full">
                ...
                {/* 2. Our Services */}
                <SectionWrapper className="bg-design3b" id="services-preview">
                    <div className="scroll-reveal">
                        ...
                        <ServiceCards cardClassName="bg-design3p" />
                    </div>
                </SectionWrapper>
                    ...
                    <div className="section-wrapper relative z-10 w-full">
                        <Card3DHoverFit>
                            <div
                                ...
                                className="max-w-xl p-10 md:p-14 rounded-[var(--radius-card)] text-left bg-design3p backdrop-blur-sm border border-[var(--border)]"
                            >
            ...
            {/* 9. Quick Contacts */}
            <SectionWrapper className="bg-design3b" id="quick-contact">
                <div className="scroll-reveal">
                    ...
                    <QuickContact cardClassName="bg-design3p" />
                </div>
            </SectionWrapper>
